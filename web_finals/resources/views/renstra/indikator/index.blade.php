    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                ...
                <form action="{{ route('renstra.indikator.store') }}" method="POST" class="flex gap-4 items-end">
                    @csrf
                    ...
                    <div class="w-1/2">
                        <label class="block text-sm font-medium text-gray-700">Nama Indikator</label>
                        <input type="text" name="nama_indikator" placeholder="Nama Indikator..." class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $item->nama_indikator }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">Belum ada indikator.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
