    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                ...
                <form action="{{ route('renstra.kategori.store') }}" method="POST" class="flex gap-4 items-end">
                    @csrf
                    
                    <div class="w-1/4">
                        <label class="block text-sm font-medium text-gray-700">Kode</label>
                        <input type="text" name="kode_kategori" placeholder="Cth: K-01" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>

                    <div class="w-1/2">
                        <label class="block text-sm font-medium text-gray-700">Nama Kategori</label>
                        <input type="text" name="nama_kategori" placeholder="Nama Kategori..." class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
