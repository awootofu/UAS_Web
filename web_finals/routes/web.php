...
Route::middleware(['auth', 'role:admin,bpap'])->group(function () {
    // Resource ditaruh di atas agar /create tidak dianggap sebagai {id}
...
Route::middleware(['auth'])->group(function () {
    ...
    // PENTING: Resource ditaruh di atas agar /evaluasi/create terbaca lebih dulu
    ...
    // View (Ditaruh paling bawah di blok ini)
